...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  mobileAgentConsole: 'agent-team.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  MemoryEntry: 'mobile console memory record is owned by packages/experimental/mobile-agent-console/src/index.ts',
  DashboardSnapshot: 'mobile console dashboard projection is owned by packages/experimental/mobile-agent-console/src/wire.ts',
