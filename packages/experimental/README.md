...
| `mobile-agent-console/` | GLM route, Agent Teams composition, authenticated mobile gateway, live dashboard, usage view, and project memory | `ctx.mobileAgentConsole` |
