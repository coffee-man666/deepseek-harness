...
需要：`webServer` · `agents` · `agentTeams` · `credentials` · `tools` · `systemPrompt`
...
来源：[`packages/experimental/mobile-agent-console/src/index.ts:59`](../packages/experimental/mobile-agent-console/src/index.ts)
...
- `@deepseek-ai/dsh-skills` — 需要 `skills`（[`packages/skill/skills/src/index.ts`](../packages/skill/skills/src/index.ts)）
