...
The same suite is also packaged for Codex at `plugins/dsh-skills`; the separate manifest and loader choice are recorded in [the Codex plugin note](2026-08-18-codex-dsh-skills-plugin.md).
